//this code same with "get_all_saved_list_button.js" becasue after click on the list box ,this code working as a button..

export function List_box_2_OnDeactivated(item) {
    for (let i = 0; i < 100 ; i++) {
